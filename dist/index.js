...
server.tool("getApiStatus", {}, async () => {
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao conectar à Evolution API: ${error.message}`
                }]
        };
    }
});
...
server.tool("getInstanceStatus", {}, async () => {
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao verificar status da instância: ${error.message}`
                }]
        };
    }
});
...
server.tool("setPresence", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao definir presença: ${error.message}`
                }]
        };
    }
});
...
server.tool("logoutInstance", {}, async () => {
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao desconectar instância: ${error.message}`
                }]
        };
    }
});
...
server.tool("restartInstance", {}, async () => {
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao reiniciar instância: ${error.message}`
                }]
        };
    }
});
...
server.tool("sendMedia", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao enviar mídia: ${error.message}`
                }]
        };
    }
});
...
server.tool("sendAudio", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao enviar áudio: ${error.message}`
                }]
        };
    }
});
...
server.tool("sendLocation", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao enviar localização: ${error.message}`
                }]
        };
    }
});
...
server.tool("sendContact", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao enviar contato: ${error.message}`
                }]
        };
    }
});
...
server.tool("sendPoll", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao enviar enquete: ${error.message}`
                }]
        };
    }
});
...
server.tool("checkWhatsAppNumber", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao verificar número: ${error.message}`
                }]
        };
    }
});
...
server.tool("markMessageAsRead", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao marcar mensagem como lida: ${error.message}`
                }]
        };
    }
});
...
server.tool("archiveChat", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao ${shouldArchive ? 'arquivar' : 'desarquivar'} chat: ${error.message}`
                }]
        };
    }
});
...
server.tool("deleteMessageForEveryone", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao excluir mensagem: ${error.message}`
                }]
        };
    }
});
...
server.tool("updateProfileName", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao atualizar nome do perfil: ${error.message}`
                }]
        };
    }
});
...
server.tool("updateProfileStatus", {
    ...
    try {
        ...
        return {
            content: [{
                    type: "text",
                    text: `Erro ao atualizar status do perfil: ${error.message}`
                }]
        };
    }
});
        ...
        return {
            contents: [{
                    ...
                    text: `Contatos disponíveis (${contacts.length}):\n${contacts
                        .map((contact) => `- ${contact.name || "Sem nome"}: ${contact.id.replace("@c.us", "")}`)
                        .join("\n")}`
                }]
        };
    }
...
server.resource("chats", new ResourceTemplate("chats://list", { list: undefined }), async (uri) => {
    try {
        ...
        return {
            contents: [{
                    ...
                    text: `Conversas disponíveis (${chats.length}):\n${chats
                        .map((chat) => `- ${chat.name || chat.id || "Chat sem nome"}`)
                        .join("\n")}`
                }]
        };
    }
        ...
        return {
            contents: [{
                    uri: uri.href,
                    text: `Erro ao buscar conversas: ${error.message}`
                }]
        };
    }
});
...
server.resource("groups", new ResourceTemplate("groups://list", { list: undefined }), async (uri) => {
    try {
        ...
        return {
            contents: [{
                    ...
                    text: `Grupos disponíveis (${groups.length}):\n${groups
                        .map((group) => `- ${group.subject || group.id || "Grupo sem nome"} (${group.participants?.length || 0} membros)`)
                        .join("\n")}`
                }]
        };
    }
        ...
        return {
            contents: [{
                    uri: uri.href,
                    text: `Erro ao buscar grupos: ${error.message}`
                }]
        };
    }
});
...
server.resource("profile", new ResourceTemplate("profile://info", { list: undefined }), async (uri) => {
    try {
        ...
        return {
            contents: [{
                    uri: uri.href,
                    text: `Erro ao buscar informações do perfil: ${error.message}`
                }]
        };
    }
});
...
server.resource("privacy", new ResourceTemplate("privacy://settings", { list: undefined }), async (uri) => {
    try {
        ...
        return {
            contents: [{
                    uri: uri.href,
                    text: `Erro ao buscar configurações de privacidade: ${error.message}`
                }]
        };
    }
});
...
export async function startWebSocketServer(port = 3000) {
