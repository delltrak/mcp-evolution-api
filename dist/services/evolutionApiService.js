...
export class EvolutionApiService {
    instanceId;
    constructor(instanceId = config.evolutionApi.instanceId) {
    ...
    async getInstanceStatus() {
        try {
            const response = await apiClient.get(`/instance/connectionState/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async sendTextMessage({ number, text, options }) {
        try {
            const response = await apiClient.post(`/message/text/${this.instanceId}`, {
                number,
    ...
    async checkWhatsAppNumber({ phone }) {
        try {
            const response = await apiClient.post(`/chat/whatsappNumbers/${this.instanceId}`, {
                numbers: [phone]
            });
            return response.data;
        }
    ...
    async sendPresence(presence, chatJid) {
        try {
    ...
    async fetchContacts() {
        try {
            const response = await apiClient.post(`/chat/contacts/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    // Buscar mensagens
    async findMessages(query, chatId) {
        try {
    ...
    async fetchChats() {
        try {
            const response = await apiClient.get(`/chat/findChats/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async fetchProfile() {
        try {
            const response = await apiClient.post(`/profile/fetchProfile/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async fetchPrivacySettings() {
        try {
            const response = await apiClient.get(`/profile/fetchPrivacySettings/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async updateGroupPicture(groupId, url) {
        try {
    ...
    async sendGroupInvite(groupId, numbers) {
        try {
    ...
    async findGroupByJid(groupId) {
        try {
            const response = await apiClient.get(`/group/findGroupByJid/${this.instanceId}/${groupId}`);
            return response.data;
        }
        catch (error) {
    ...
    async fetchAllGroups() {
        try {
            const response = await apiClient.get(`/group/fetchAllGroups/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async toggleEphemeral(groupId, expiration) {
        try {
    ...
    async findTypebot() {
        try {
            const response = await apiClient.get(`/typebot/find/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
    ...
    async changeTypebotStatus(enabled) {
        try {
    ...
    async findChatwoot() {
        try {
            const response = await apiClient.get(`/chatwoot/find/${this.instanceId}`);
            return response.data;
        }
        catch (error) {
